...
console.log(
    'This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: node populatedb "mongodb+srv://suhailkhan250899:59NT3KAsKDv6di1k@cluster0.lz91hw2.mongodb.net/local_library?retryWrites=true&w=majority"'
  );
  ...
  async function main() {
    ...
    const query = await Genre.find({name:'Fantasy'});
    // console.log(query);
